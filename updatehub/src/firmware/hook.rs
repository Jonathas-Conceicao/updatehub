...
use crate::firmware::{metadata_value::MetadataValue, Error};
...
pub(crate) fn run_hooks_from_dir(path: &Path) -> Result<MetadataValue, Error> {
...
pub(crate) fn run_script(cmd: &str) -> Result<String, Error> {
